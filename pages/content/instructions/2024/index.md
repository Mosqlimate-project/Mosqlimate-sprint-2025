...
1. **Review the Sprint Rules:** Carefully read the sprint rules [here](../../sprint/2024).
2. **Register for the Sprint:** Complete your registration here.
3. **Access Data Documentation:** Explore the documentation of the data provided for the challenge [here](../data/2024).

### Registering Your Model and Submitting Predictions

To register your model and submit predictions using the Mosqlimate API, refer to the [Sprint Template GitHub repository](https://github.com/Mosqlimate-project/sprint-template). The repository includes examples of how to send your predictions using Python or R.
